      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse mt-2" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link text-center badge-pill badge-warning" href="daftar_menu.php">DAFTAR MENU</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
      ...
      <?php foreach ($result as $result) : ?>
        ...
        <div class="col-md-3 mt-4">
          ...
          <div class="card brder-dark bg-dark text-white">
            ...
            <div class="card-body">
              ...
              <a href="hapus_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light" onclick="return confirm ('Apakah yakin data akan dihapus?')">HAPUS</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
