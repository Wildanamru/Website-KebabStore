            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse mt-2" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link text-center badge-pill badge-warning" href="user.php">HOME</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-center" href="user_promosi.php">PROMOSI</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <div class="container mt-3">
            <div class="card bg-dark text-white border-light text-center">
                ...
                <div class="card-body">
                    <a href="user_promosi.php" class="btn" style="background-color: #008080; color: white;">PROMO TERBARU</a>
                </div>
            </div>
        </div>
    <!--  END Section hero -->
                ...
                <div class="justify-content-end">
                    <div class="card bg-dark text-white border-light">
                        ...
                        <div class="text-center  mb-3 mt-3">
                            <a href="menu_user.php" class="btn" style="background-color: #008080; color: white;">LIHAT DAFTAR MENU</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-5 mt-5">
                <div class="justify-content-end">
                    <div class="card bg-dark text-white border-light">
                        ...
                        <div class="text-center  mb-3 mt-3">
                            <a href="user_cabang.php" class="btn" style="background-color: #008080; color: white;">LIHAT DAFTAR CABANG</a>
                        </div>
                    </div>
                </div>
            </div>
