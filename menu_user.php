            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse mt-2" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-center" href="user.php">PROMOSI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-center badge-pill badge-warning" href="menu_pembeli.php">DAFTAR MENU</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="row mt-3">
            ...
            <?php foreach ($result as $result) : ?>
                ...
                <div class="col-md-3 mt-4">
                    ...
                    <div class="card brder-dark text-white bg-dark">
                        ...
                        <div class="card-body">
                            ...
                            <label class="harga btn btn-success btn-block "><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label>
